...
// #include "assets/power_massage_background.h"

PowerMassageScreen::PowerMassageScreen(UIManager* uiManager) : ui(uiManager) {}
...
void PowerMassageScreen::draw(Arduino_Canvas* canvas) {
    ...
    // Draw the background for the Power Massage screen
    // canvas->draw16bitRGBBitmap(0, 0, power_massage_background, 480, 480);
...
void PowerMassageScreen::handleTouch(int x, int y) {
    for (auto& button : buttons) {
