...
// #include "assets/awareness_background.h"

AwarenessScreen::AwarenessScreen(UIManager* uiManager) : ui(uiManager) {}
...
void AwarenessScreen::draw(Arduino_Canvas* canvas) {
    ...
    // Draw the background for the Awareness screen
    // canvas->draw16bitRGBBitmap(0, 0, awareness_background, 480, 480);
...
void AwarenessScreen::handleTouch(int x, int y) {
    for (auto& button : buttons) {
