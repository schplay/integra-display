...
// #include "assets/affirmation_background.h"

AffirmationScreen::AffirmationScreen(UIManager* uiManager) : ui(uiManager) {}
...
void AffirmationScreen::draw(Arduino_Canvas* canvas) {
    ...
    // Draw the background for the Affirmation screen
    // canvas->draw16bitRGBBitmap(0, 0, affirmation_background, 480, 480);
...
void AffirmationScreen::handleTouch(int x, int y) {
    for (auto& button : buttons) {
